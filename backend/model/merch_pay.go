...
type MerchPay struct {
	...
	Code          *string    `json:"code" gorm:"size:191;uniqueIndex;comment:订单号"`          // 订单号
	MerchsID      *int32     `json:"merId" gorm:"index;comment:商家外键"`                       // 商家外键
	Name          *string    `json:"name" gorm:"size:191;index;comment:商品名称"`               // 商品名称
	ReqDate       *string    `json:"reqDate" gorm:"size:255;comment:汇付支付时间"`                // 汇付支付时间
	HfSeqId       *string    `json:"hfSeqId" gorm:"size:191;comment:汇付订单号"`                 // 汇付订单号
	...
	Type          *string    `json:"type" gorm:"size:191;default:'0';comment:订单类型 0短信 1广告 2年费"`      // 订单类型 0短信 1广告 2年费
	Status        *string    `json:"status" gorm:"size:191;default:'0';comment:订单状态 0待支付 1已支付 2已关闭"` // 订单状态 0待支付 1已支付 2已关闭
