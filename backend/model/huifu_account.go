...
type HuifuAccount struct {
	...
	Area      string     `json:"area" gorm:"comment:经营地址"`                      // 经营地址
	Picture   string     `json:"picture" gorm:"comment:店铺图片"`                   // 店铺图片
	Remarks   string     `json:"remarks" gorm:"comment:使用场景描述"`                 // 使用场景描述，text类型
