...
func WxJsApiPay(c *gin.Context) {
	...
	// 设置非必填字段
	dgReq.ExtendInfos = GetjsapiExtendInfos()
	...
	if !ok {
		response.Fail(c, 400, "响应数据格式错误", resp)
		return
	}
	// 获取pay_info并解析
 ...
 * 非必填字段
 */
func GetjsapiExtendInfos() map[string]interface{} {
	// 设置非必填字段
	extendInfoMap := make(map[string]interface{})
	// 交易有效期
	// extendInfoMap["time_expire"] = tool.GetCurrentTime()
	// 微信参数集合
	extendInfoMap["wx_data"] = "{\"sub_appid\":\"wxfc42adf0c2f58bb6\",\"sub_openid\":\"o5X3A6b0UTYT60Y5pZkmqMkOAsNQ\",\"detail\":{\"cost_price\":\"43.00\",\"receipt_id\":\"20220628132043853798\",\"goods_detail\":[{\"goods_id\":\"6934572310301\",\"goods_name\":\"太龙双黄连口服液\",\"price\":\"43.00\",\"quantity\":\"1\",\"wxpay_goods_id\":\"12235413214070356458058\"}]}}"
	// 是否延迟交易
